...
export function Container({ children }: { children: ReactNode }) {
  return (
    <div className="relative">
      <section className="flex h-[550px] flex-col items-center justify-center gap-4 bg-red-500 bg-[url('/background/stars-bg-red.png')] bg-cover px-6 md:h-[700px] lg:px-20">
        <Image
