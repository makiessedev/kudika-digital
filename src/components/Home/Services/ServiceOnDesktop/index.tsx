...
export function ServiceOnDesktop() {
  return (
    <section className="mt-10 flex flex-col">
      <div className="flex">
        <div className="flex h-[394px] w-[151px] items-center justify-center bg-red-500 text-6xl font-black text-gray-100 ">
          1
        </div>

        <div className="flex flex-col items-center justify-center gap-5 px-6">
          <h3 className="w-[349px] text-3xl font-black uppercase text-gray-500">
            Gestão das redes sociais
          </h3>
          <p className="text-gray-400 w-[349px] text-lg font-normal">
        ...
        <div className="flex h-[394px] w-[643px] justify-center bg-red-500">
          <Image
